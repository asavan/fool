...
var _index = require("./node_modules/@supabase/supabase-js/dist/module/index.js");
...
function main() {
  const supabase = (0, _index.createClient)(SUPABASE_URL, SUPA_API_ANON_KEY);
...
},{"./node_modules/@supabase/supabase-js/dist/module/index.js":54}],2:[function(require,module,exports){
"use strict";
...
},{"./GoTrueAdminApi":4}],3:[function(require,module,exports){
"use strict";
...
},{"./GoTrueClient":5}],4:[function(require,module,exports){
"use strict";
...
},{"./lib/errors":9,"./lib/fetch":10,"./lib/helpers":11}],5:[function(require,module,exports){
"use strict";
...
class GoTrueClient {
  ...
  async fetchJwk(kid, jwks = {
    ...
    if (jwk && this.jwks_cached_at + _constants.JWKS_TTL > Date.now()) {
      return jwk;
    }
    ...
    if (!data.keys || data.keys.length === 0) {
      throw new _errors.AuthInvalidJwtError('JWKS is empty');
    }
    this.jwks = data;
    ...
    if (!jwk) {
      throw new _errors.AuthInvalidJwtError('No matching signing key found in JWKS');
    }
    return jwk;
  }
  /**
...
},{"./GoTrueAdminApi":4,"./lib/base64url":7,"./lib/constants":8,"./lib/errors":9,"./lib/fetch":10,"./lib/helpers":11,"./lib/local-storage":12,"./lib/locks":13,"./lib/polyfills":14,"./lib/version":16}],6:[function(require,module,exports){
"use strict";
...
},{"./AuthAdminApi":2,"./AuthClient":3,"./GoTrueAdminApi":4,"./GoTrueClient":5,"./lib/errors":9,"./lib/locks":13,"./lib/types":15}],7:[function(require,module,exports){
"use strict";
...
},{"./version":16}],9:[function(require,module,exports){
"use strict";
...
},{"./constants":8,"./errors":9,"./helpers":11}],11:[function(require,module,exports){
"use strict";
...
},{"./base64url":7,"./constants":8,"./errors":9}],12:[function(require,module,exports){
"use strict";
...
const version = exports.version = '2.69.1';
...
},{"./helper":18,"./types":20}],18:[function(require,module,exports){
"use strict";
...
},{"./FunctionsClient":17,"./types":20}],20:[function(require,module,exports){
"use strict";
...
},{"./PostgrestError":24,"@supabase/node-fetch":21}],23:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./PostgrestFilterBuilder":25,"./PostgrestQueryBuilder":26,"./constants":28}],24:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
 * Error format
...
},{"./PostgrestTransformBuilder":27}],26:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./PostgrestFilterBuilder":25}],27:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./PostgrestBuilder":22}],28:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./PostgrestBuilder":22,"./PostgrestClient":23,"./PostgrestError":24,"./PostgrestFilterBuilder":25,"./PostgrestQueryBuilder":26,"./PostgrestTransformBuilder":27}],30:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.version = void 0;
...
},{"../cjs/index.js":29}],32:[function(require,module,exports){
"use strict";
...
},{"./RealtimePresence":34,"./lib/constants":37,"./lib/push":38,"./lib/timer":40,"./lib/transformers":41}],33:[function(require,module,exports){
"use strict";
...
class RealtimeClient {
  ...
  connect() {
    ...
    if (!this.transport) {
      this.transport = _WebSocket.default;
    }
    if (this.transport) {
...
},{"./RealtimeChannel":32,"./WebSocket":35,"./lib/constants":37,"./lib/serializer":39,"./lib/timer":40,"./lib/transformers":41}],34:[function(require,module,exports){
"use strict";
...
var _default = exports.default = WebSocketImpl;

},{"ws":63}],36:[function(require,module,exports){
"use strict";
...
},{"./RealtimeChannel":32,"./RealtimeClient":33,"./RealtimePresence":34}],37:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.WS_CLOSE_NORMAL = exports.VSN = exports.VERSION = exports.TRANSPORTS = exports.SOCKET_STATES = exports.DEFAULT_TIMEOUT = exports.DEFAULT_HEADERS = exports.CONNECTION_STATE = exports.CHANNEL_STATES = exports.CHANNEL_EVENTS = void 0;
var _version = require("./version");
const DEFAULT_HEADERS = exports.DEFAULT_HEADERS = {
...
},{"./version":42}],38:[function(require,module,exports){
"use strict";
...
},{"../lib/constants":37}],39:[function(require,module,exports){
"use strict";
...
exports.version = void 0;
const version = exports.version = '2.11.9';
...
},{"./packages/StorageBucketApi":51,"./packages/StorageFileApi":52}],44:[function(require,module,exports){
"use strict";
...
},{"./StorageClient":43,"./lib/errors":46,"./lib/types":49}],45:[function(require,module,exports){
"use strict";
...
},{"./version":50}],46:[function(require,module,exports){
"use strict";
...
},{"./errors":46,"./helpers":48}],48:[function(require,module,exports){
"use strict";
...
},{"../lib/constants":45,"../lib/errors":46,"../lib/fetch":47,"../lib/helpers":48}],52:[function(require,module,exports){
...
},{"../lib/errors":46,"../lib/fetch":47,"../lib/helpers":48,"buffer":61}],53:[function(require,module,exports){
"use strict";
...
class SupabaseClient {
   ...
   */
  get storage() {
    return new _storageJs.StorageClient(this.storageUrl.href, this.headers, this.fetch);
  }
  /**
   * Perform a query on a table or a view.
   *
...
},{"./lib/SupabaseAuthClient":55,"./lib/constants":56,"./lib/fetch":57,"./lib/helpers":58,"@supabase/functions-js":19,"@supabase/postgrest-js":31,"@supabase/realtime-js":36,"@supabase/storage-js":44}],54:[function(require,module,exports){
"use strict";
...
},{"./SupabaseClient":53,"@supabase/auth-js":6,"@supabase/functions-js":19,"@supabase/postgrest-js":31,"@supabase/realtime-js":36}],55:[function(require,module,exports){
"use strict";
...
},{"@supabase/auth-js":6}],56:[function(require,module,exports){
"use strict";
...
},{"@supabase/node-fetch":21}],58:[function(require,module,exports){
"use strict";
...
exports.version = void 0;
const version = exports.version = '2.49.9';
